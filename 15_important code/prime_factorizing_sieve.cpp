...
// Complexity O(logN) per call..
// this will only work in while mxN <= 10^7
void PrimeFactorisation_logN(int x) {
    vector <int> pf ;
...
int main() { 
    ...
    int n ;
    while(cin >> n) {
        PrimeFactorisation_logN(n) ; // getting the prime factors of n..
        cout << "\n" ;
    }
    return 0 ;
}