...
int main()
{
    ...
    int input;
    cout<<"--------------------------------------------------------------------------"<<endl;
    cout<<"           GPA & CGPA Calculator (Developed by Iqbal, Sharial, Aminul)             "<<endl;
    cout<<"--------------------------------------------------------------------------\n"<<endl;
    cout<<"           MENU:"<<endl;
    ...
    switch(input)
    {
        ...
        case 3:
                ...
                break;
        case 4:
                exit(EXIT_SUCCESS); // this line have to understand
                break;
        default:
            cout<<"You have entered wrong input.Try again!\n"<<endl;
            goto sub; // this line have to understand
            break;
    }
}
...
{
    int q;
    system("cls");  // this line have to understand
    ...
    sub: // this line have to understand
    int inmenu;
